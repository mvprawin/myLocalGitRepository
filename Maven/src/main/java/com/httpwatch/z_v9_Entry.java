 ...
 */
@IID("{C972CF14-E223-48E0-9D25-2BCF1550A74C}")
public interface z_v9_Entry extends Com4jObject {
  // Methods:
  /**
   * <p>
  ...
  /**
   * <p>
   * The ID of the SPDY stream used by this request. (0 for non-SPDY requests)
   * </p>
   * <p>
   * Getter method for the COM property "SPDYStreamID"
   * </p>
   * @return  Returns a value of type int
   */
